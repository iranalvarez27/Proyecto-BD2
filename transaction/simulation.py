...
def construir_entorno(data_dir: str) -> Catalog:
    ...
    bplus = BPlusTree(os.path.join(data_dir, "estudiantes_id.idx"), DataType.INT)
    catalog.register_index("estudiantes", "id", bplus, INDEX_BPLUS)
    hash_idx = ExtendibleHash(os.path.join(data_dir, "estudiantes_carrera.idx"))
    ...
    clustered = ClusteredBPlusTree(seq, os.path.join(data_dir, "cursos_clustered.idx"))
...
def main():
    ...
    catalog = construir_entorno(data_dir)
